...
|---|---|---|---|
| Long line, fixture untreated | **Not trustworthy** (fixture detected) | +14.3% | +6.6% |
| Delta-L | **Partially usable** (roughness not identifiable) | +3.7% | −2.9% |
| Delta-L with roughness fixed | **Trustworthy** | +3.8% | +1.2% |
